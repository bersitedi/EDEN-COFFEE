...
const MeetOurTeamComponent = () => {
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="flex flex-col justify-start items-start space-x-4 w-full py-3 px-4 shadow-gray-400 shadow-sm lg:mt-5 md:mb-3">
        <span className="flex items-center justify-center lg:px-8">
